...
public class CryptoUtil {
	...
	public static final String DEFAULT_SECRET_KEY = "1qaz2wsx3edc$RFV%TGB^YHN&UJMwangguan";
	...
	public static String encode(String key, String str) {
		...
		//return Hex.encodeHexString(obtainEncode(key, str.getBytes())); // 可以转化为16进制数据
	}
...
//	}catch(DecoderException e){ // TODO Auto-generated catch block //
//  e.printStackTrace(); 
//  
//	} 
		}
	...
	public static void main(String[] args) {
	    ...
	    String n = decode(m); System.out.println(n); }
}
