...
public class LoginServiceImpl implements LoginService {
	...
	@Override
	public JSONObject frontAuth(JSONObject request2Json) {
		// TODO Auto-generated method stub
		request2Json.put("username", request2Json.get("nickName"));
		request2Json.put("nickname", request2Json.get("nickName"));
		request2Json.put("password", "123456");
