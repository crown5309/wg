<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="显示顺序" prop="show_order"></el-table-column>
      <el-table-column align="center" label="京东链接" prop="jingdong_link"></el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form class="small-space" :model="goodsClass" label-position="left" label-width="80px" style='width: 300px; margin-left:80px;'>
        ...
        <el-form-item label="显示顺序">
          <el-input type="number" v-model="goodsClass.show_order">
          </el-input>
        </el-form-item>
